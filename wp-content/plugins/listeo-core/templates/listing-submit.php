...
$steps_status = get_option("listeo_enable_{$listing_type}_form_steps", 'off');

?>

<div class="submit-page <?php echo esc_attr('type-' . $listing_type); if ($steps_status === 'on' && !empty($steps)) { echo ' multi-step-form'; } ?>">
